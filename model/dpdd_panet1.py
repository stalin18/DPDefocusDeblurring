...
class DPDD_PANet1(nn.Module):
    def __init__(self):
        ...
        self.pam1 = PAM(in_channels=32, interim_channels=32)
        ...
        self.pam2 = PAM(in_channels=64, interim_channels=64)
        ...
        self.pam3 = PAM(in_channels=128, interim_channels=128)
        ...
        self.pam4 = PAM(in_channels=256, interim_channels=256)
        ...
        # decoder layer 1
        self.upsample6 = nn.Conv2d(in_channels=512, out_channels=256, kernel_size=3, stride=1, padding=1)
        ...
        self.conv6_1 = nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3, stride=1, padding=1)
        self.relu6_1 = nn.ReLU(inplace=True)
        # decoder layer 2
        self.upsample7 = nn.Conv2d(in_channels=256, out_channels=128, kernel_size=3, stride=1, padding=1)
        ...
        # decoder layer 3
        self.upsample8 = nn.Conv2d(in_channels=128, out_channels=64, kernel_size=3, stride=1, padding=1)
        self.upsample8_relu = nn.ReLU(inplace=True)
        self.conv8 = nn.Conv2d(in_channels=128, out_channels=64, kernel_size=3, stride=1, padding=1)
        self.relu8 = nn.ReLU(inplace=True)
        self.conv8_1 = nn.Conv2d(in_channels=64, out_channels=64, kernel_size=3, stride=1, padding=1)
        self.relu8_1 = nn.ReLU(inplace=True)
        # decoder layer 4
        self.upsample9 = nn.Conv2d(in_channels=64, out_channels=32, kernel_size=3, stride=1, padding=1)
        self.upsample9_relu = nn.ReLU(inplace=True)
        self.conv9 = nn.Conv2d(in_channels=64, out_channels=32, kernel_size=3, stride=1, padding=1)
        self.relu9 = nn.ReLU(inplace=True)
        self.conv9_1 = nn.Conv2d(in_channels=32, out_channels=32, kernel_size=3, stride=1, padding=1)
        self.relu9_1 = nn.ReLU(inplace=True)
        # final output layer
        self.conv9_2 = nn.Conv2d(in_channels=32, out_channels=3, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, dp_left, dp_right):
        ...
        left_pooled_output4 = self.pool4(left_output4)

        right_output4 = self.conv4(pam_right_output3)
        right_pooled_output4 = self.pool4(right_output4)
        ...
        # decoder layer 1
        upsampled6_output = self.upsample6_relu(self.upsample6(upsample(left_output5 + right_output5)))
        merged6 = torch.cat((upsampled6_output, nn.ReLU(inplace=True)(left_output4 + right_output4)), dim=1)
        ...
        merged7 = torch.cat((upsampled7_output, nn.ReLU(inplace=True)(left_output3 + right_output3)), dim=1)
        ...
        merged8 = torch.cat((upsampled8_output, nn.ReLU(inplace=True)(left_output2 + right_output2)), dim=1)
        ...
        merged9 = torch.cat((upsampled9_output, nn.ReLU(inplace=True)(left_output1 + right_output1)), dim=1)
