...
class DPDD_PANet2_1(nn.Module):
    def __init__(self, dropout_rate=0.4):
        ...
        self.pam1 = PAM3(in_channels=32, interim_channels=32)
        ...
        self.pam2 = PAM3(in_channels=64, interim_channels=64)
        ...
        self.pam3 = PAM3(in_channels=128, interim_channels=128)
        ...
        self.pam4 = PAM3(in_channels=256, interim_channels=256)
